...
def calculate_demographic_data(print_data=True):
    ...
    # print(higher_education["salary"].info())
    ...
    highest_earning_country_percentage =round( (df[df["salary"]==">50K"].value_counts("native-country") / df.value_counts("native-country")).sort_values(ascending=False).loc[highest_earning_country]*100,1)
